...
const FavoriteList = () => {
  const [medias, setMedias] = useState([]); // State to store all favorite media items
  const [filteredMedias, setFilteredMedias] = useState([]); // State to store the currently displayed media items
  ...
  useEffect(() => {
    const getFavorites = async () => {
      ...
      const { response, err } = await favoriteApi.getList(); // Fetch list of favorite items
